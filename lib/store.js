(function() {
  var NotificationMethods, NotificationSchema, Store, mongoose, _;
  ...
  module.exports = Store = (function() {
    ...
    function Store(settings) {
      ...
      this.schemas = [NotificationSchema];
      _ref = this.schemas;
      ...
      this.notifications = new NotificationMethods(this.models);
      this.methodNames = ['notifications'];
    }
